...
def main():
    ...
    wappalyzer_json_url = "https://raw.githubusercontent.com/iiiusky/WappalyzerParse/main/technologies.json"
    ...
    descriptions['Referrer-Policy'] = que('Referrer-Policy Referrer Policy is a header that allows a site to control how much information the browser includes with navigations away from a document and should be set by all sites.')
